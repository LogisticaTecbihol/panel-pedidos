-- Agregar columna Bodega_Facturacion a Pedidos (solo aplica para PARCELAR)
ALTER TABLE "Pedidos" ADD COLUMN IF NOT EXISTS "Bodega_Facturacion" text DEFAULT '';

-- Actualizar funcion editar_pedido_completo para incluir Bodega_Facturacion
  ...
  LOOP
    ...
    ELSE
      INSERT INTO "Pedidos" (
        ...
        "Facturar_A","NIT_Adicional","Consignacion","Bodega_Facturacion",
        creado_por
      ) VALUES (
