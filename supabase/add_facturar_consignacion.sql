-- Agregar columnas: Facturar_A, NIT_Adicional, Consignacion a Pedidos
ALTER TABLE "Pedidos" ADD COLUMN IF NOT EXISTS "Facturar_A" text DEFAULT '';
ALTER TABLE "Pedidos" ADD COLUMN IF NOT EXISTS "NIT_Adicional" text DEFAULT '';
ALTER TABLE "Pedidos" ADD COLUMN IF NOT EXISTS "Consignacion" text DEFAULT 'No';

-- Actualizar funcion editar_pedido_completo para incluir nuevos campos
  ...
  LOOP
    ...
    ELSE
      INSERT INTO "Pedidos" (
        ...
        "Facturar_A","NIT_Adicional","Consignacion"
      ) VALUES (
